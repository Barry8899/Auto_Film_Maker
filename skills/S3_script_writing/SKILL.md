...
Before doing anything else, DO NOT overthink or explain. Immediately check if `/home/admin/.openclaw/workspace/auto_film_maker/repo/S3_Script_Writing/<video_name>/features.json` AND `/home/admin/.openclaw/workspace/auto_film_maker/repo/S3_Script_Writing/<video_name>/script.md` already exist.
